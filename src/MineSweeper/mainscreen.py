...
class MainScreen:
    ...
    def show_game_over_screen(self):
        self.draw_centered_text("G A M E  O V E R", common.BIG_FONT, 200, alliasing=True, colour=common.RED)
        ...
        if self.game_state.game_result_type == common.GameResultType.WIN:
            self.draw_centered_text("W I N", common.BIG_FONT, 300, alliasing=True, colour=common.RED)

        if self.game_state.game_result_type == common.GameResultType.LOST:
            self.draw_centered_text("L O S T", common.BIG_FONT, 300, alliasing=True, colour=common.RED)
